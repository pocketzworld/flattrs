...
class UnionOfNestedTables(object):
    ...
    @classmethod
    def GetRootAsUnionOfNestedTables(cls, buf, offset=0):
...
def Start(builder):
    return UnionOfNestedTablesStart(builder)
...
def AddInnerUnionType(builder, innerUnionType):
    return UnionOfNestedTablesAddInnerUnionType(builder, innerUnionType)
...
def AddInnerUnion(builder, innerUnion):
    return UnionOfNestedTablesAddInnerUnion(builder, innerUnion)
def UnionOfNestedTablesEnd(builder): return builder.EndObject()
def End(builder):
    return UnionOfNestedTablesEnd(builder)